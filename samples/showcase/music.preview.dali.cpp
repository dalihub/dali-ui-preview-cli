...
eq.Add(e1); eq.Add(e2); eq.Add(e3); eq.Add(e4); eq.Add(e5); eq.Add(e6); eq.Add(e7); eq.Add(e8); eq.Add(e9);
...
ctr.Add(pv); ctr.Add(play); ctr.Add(nx);

root.Add(eq); root.Add(now); root.Add(song); root.Add(artist); root.Add(bar); root.Add(ctr);
return root;
