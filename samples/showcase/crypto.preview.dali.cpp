...
bars.Add(g1); bars.Add(g2); bars.Add(g3); bars.Add(g4); bars.Add(g5); bars.Add(g6); bars.Add(g7); bars.Add(g8);
chart.Add(cl); chart.Add(bars);
...
c1.Add(c1n); c1.Add(c1p); c1.Add(c1c);
...
c2.Add(c2n); c2.Add(c2p); c2.Add(c2c);
...
c3.Add(c3n); c3.Add(c3p); c3.Add(c3c);
coins.Add(c1); coins.Add(c2); coins.Add(c3);

root.Add(header); root.Add(chart); root.Add(coins);
return root;
