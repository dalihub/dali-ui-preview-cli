...
k1.Add(k1a); k1.Add(k1b); k1.Add(k1c);
...
k2.Add(k2a); k2.Add(k2b); k2.Add(k2c);
...
k3.Add(k3a); k3.Add(k3b); k3.Add(k3c);
kpis.Add(k1); kpis.Add(k2); kpis.Add(k3);
...
bars.Add(b1); bars.Add(b2); bars.Add(b3); bars.Add(b4); bars.Add(b5); bars.Add(b6); bars.Add(b7);
card.Add(cl); card.Add(bars);

root.Add(head); root.Add(kpis); root.Add(card);
return root;
