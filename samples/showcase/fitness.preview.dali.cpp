...
track.Add(fill);
hero.Add(hs1); hero.Add(hr); hero.Add(track);
...
s1c.Add(s1a); s1c.Add(s1b); s1c.Add(s1d); s1.Add(s1c);
...
s2c.Add(s2a); s2c.Add(s2b); s2c.Add(s2d); s2.Add(s2c);
...
s3c.Add(s3a); s3c.Add(s3b); s3c.Add(s3d); s3.Add(s3c);
row.Add(s1); row.Add(s2); row.Add(s3);

root.Add(head); root.Add(hero); root.Add(row);
return root;
