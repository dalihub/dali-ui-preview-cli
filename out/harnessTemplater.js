...
exports.THEME_BACKGROUND = void 0;
exports.templateHarness = templateHarness;
exports.userCodeOffset = userCodeOffset;
 ...
 */
function uiConfigSetup(brokenImageUrl) {
    if (!brokenImageUrl) {
 ...
 */
function fillPlaceholder(source, name, value) {
 ...
 */
function templateHarness(userCode, opts = {}) {
    ...
    if (leftover) {
        throw new Error(`Harness template still contains an unfilled placeholder '${leftover[0]}' ` +
 ...
 */
function userCodeOffset(templatePath) {
    ...
    return (0, errorParser_1.getHarnessCodeOffset)(template);
}
